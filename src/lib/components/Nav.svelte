...
<nav class="flex items-center justify-center gap-4">
	<a href="/" class="flex items-center gap-4">
		...
		<p class="text-xl font-bold">Dropbox</p>
	</a>
	<div class="ml-4 mt-1 flex items-center justify-between gap-8">
		<Dropdown />
		<p
			class="font-semibold text-gray-700 duration-200 hover:text-[#0000f0] dark:text-gray-100 dark:hover:text-[#0000f0]"
		>
			Enterprise
		</p>
		<p
